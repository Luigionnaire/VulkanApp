...
Device::Device(const VkInstance& instance, VkSurfaceKHR& surface) {
	m_instance = instance;
	m_surface = surface;
...
bool Device::isDeviceSuitable(VkPhysicalDevice device) // can be used to only allow certain devices based on capabilities
{
