...
class RenderPass {
public:
	RenderPass(VkDevice device, VkFormat swapChainImageFormat, VkFormat depthFormat) : m_device(device), m_swapChainImageFormat(swapChainImageFormat), m_depthFormat(depthFormat){
		createRenderPass();
	}
	~RenderPass() {
